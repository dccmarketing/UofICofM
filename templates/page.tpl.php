...
/**
 * @file
 * UofICofM's theme implementation to display a single Drupal page.
 *
...
<div class="page">
	<div class="wrap">
		...
		<div id="header" class="header">
			...
			if ( $main_menu ) :
				...
				?><nav id="main-menu" class="main-menu navigation"><?php
	...
	if ( $messages ) :
		...
		?><div id="messages">
			<div class="section clearfix"><?php
		
				print $messages;
	
			?></div>
		</div> <!-- /.section, /#messages --><?php

	endif; ?>

		<div id="main-wrapper" class="clearfix"><div id="main" class="clearfix"><?php
